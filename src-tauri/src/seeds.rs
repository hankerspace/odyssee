...
pub(crate) const SECTIONS: [SectionSeed; 48] = [
  SectionSeed { id: "animals", domain_id: "nature", article_id: "arctic-fox", icon: "PawPrint", name_fr: "Animaux", name_en: "Animals" },
  SectionSeed { id: "cold-animals", domain_id: "nature", article_id: "arctic-fox", icon: "PawPrint", name_fr: "Animaux du froid", name_en: "Cold-Weather Animals" },
  SectionSeed { id: "oceans", domain_id: "nature", article_id: "coral-reef", icon: "Waves", name_fr: "Océans", name_en: "Oceans" },
  SectionSeed { id: "reefs", domain_id: "nature", article_id: "coral-reef", icon: "Waves", name_fr: "Récifs", name_en: "Reefs" },
  SectionSeed { id: "forests", domain_id: "nature", article_id: "redwood", icon: "TreePine", name_fr: "Forêts", name_en: "Forests" },
  SectionSeed { id: "giant-trees", domain_id: "nature", article_id: "redwood", icon: "TreePine", name_fr: "Arbres géants", name_en: "Giant Trees" },
  SectionSeed { id: "planets", domain_id: "space", article_id: "saturn", icon: "Orbit", name_fr: "Planètes", name_en: "Planets" },
  SectionSeed { id: "rings-and-moons", domain_id: "space", article_id: "saturn", icon: "Orbit", name_fr: "Anneaux et lunes", name_en: "Rings and Moons" },
  SectionSeed { id: "missions", domain_id: "space", article_id: "apollo-11", icon: "Moon", name_fr: "Missions", name_en: "Missions" },
  SectionSeed { id: "astronauts", domain_id: "space", article_id: "apollo-11", icon: "Rocket", name_fr: "Astronautes", name_en: "Astronauts" },
  SectionSeed { id: "stars", domain_id: "space", article_id: "sun", icon: "Sun", name_fr: "Étoiles", name_en: "Stars" },
  SectionSeed { id: "sunlight", domain_id: "space", article_id: "sun", icon: "Sun", name_fr: "Lumière du Soleil", name_en: "Sunlight" },
  ...
  SectionSeed { id: "pyramids", domain_id: "history", article_id: "egypt", icon: "Landmark", name_fr: "Pyramides", name_en: "Pyramids" },
  ...
  SectionSeed { id: "books-and-ideas", domain_id: "history", article_id: "printing-press", icon: "BookOpen", name_fr: "Livres et idées", name_en: "Books and Ideas" },
  SectionSeed { id: "explorers", domain_id: "history", article_id: "magellan", icon: "Compass", name_fr: "Explorateurs", name_en: "Explorers" },
  SectionSeed { id: "great-journeys", domain_id: "history", article_id: "magellan", icon: "Compass", name_fr: "Grands voyages", name_en: "Great Journeys" },
  SectionSeed { id: "robots", domain_id: "technology", article_id: "mars-rover", icon: "Bot", name_fr: "Robots", name_en: "Robots" },
  SectionSeed { id: "robot-explorers", domain_id: "technology", article_id: "mars-rover", icon: "Bot", name_fr: "Robots explorateurs", name_en: "Robot Explorers" },
  SectionSeed { id: "energy", domain_id: "technology", article_id: "solar-panels", icon: "Zap", name_fr: "Énergie", name_en: "Energy" },
  SectionSeed { id: "solar-energy", domain_id: "technology", article_id: "solar-panels", icon: "Sun", name_fr: "Énergie solaire", name_en: "Solar Energy" },
  SectionSeed { id: "transport", domain_id: "technology", article_id: "high-speed-train", icon: "Train", name_fr: "Transport", name_en: "Transport" },
  SectionSeed { id: "fast-trains", domain_id: "technology", article_id: "high-speed-train", icon: "Train", name_fr: "Trains rapides", name_en: "Fast Trains" },
  SectionSeed { id: "skeleton", domain_id: "human-body", article_id: "femur", icon: "Bone", name_fr: "Squelette", name_en: "Skeleton" },
  SectionSeed { id: "bones-and-joints", domain_id: "human-body", article_id: "femur", icon: "Bone", name_fr: "Os et articulations", name_en: "Bones and Joints" },
  SectionSeed { id: "brain", domain_id: "human-body", article_id: "neurons", icon: "Brain", name_fr: "Cerveau", name_en: "Brain" },
  SectionSeed { id: "nerve-messages", domain_id: "human-body", article_id: "neurons", icon: "Brain", name_fr: "Messages nerveux", name_en: "Nerve Messages" },
  SectionSeed { id: "senses", domain_id: "human-body", article_id: "eyes", icon: "Eye", name_fr: "Sens", name_en: "Senses" },
  SectionSeed { id: "sight", domain_id: "human-body", article_id: "eyes", icon: "Eye", name_fr: "Vue", name_en: "Sight" },
  SectionSeed { id: "music", domain_id: "arts", article_id: "violin", icon: "Music", name_fr: "Musique", name_en: "Music" },
  SectionSeed { id: "instruments", domain_id: "arts", article_id: "violin", icon: "Music", name_fr: "Instruments", name_en: "Instruments" },
  SectionSeed { id: "painting", domain_id: "arts", article_id: "watercolor", icon: "Brush", name_fr: "Peinture", name_en: "Painting" },
  SectionSeed { id: "colors", domain_id: "arts", article_id: "watercolor", icon: "Palette", name_fr: "Couleurs", name_en: "Colors" },
  SectionSeed { id: "sculpture", domain_id: "arts", article_id: "marble", icon: "Gem", name_fr: "Sculpture", name_en: "Sculpture" },
  SectionSeed { id: "materials", domain_id: "arts", article_id: "marble", icon: "Gem", name_fr: "Matières", name_en: "Materials" },
  SectionSeed { id: "rocks", domain_id: "earth", article_id: "volcano", icon: "Gem", name_fr: "Roches", name_en: "Rocks" },
  SectionSeed { id: "volcanoes", domain_id: "earth", article_id: "volcano", icon: "Gem", name_fr: "Volcans", name_en: "Volcanoes" },
  SectionSeed { id: "weather", domain_id: "earth", article_id: "clouds", icon: "Sun", name_fr: "Météo", name_en: "Weather" },
  SectionSeed { id: "clouds", domain_id: "earth", article_id: "clouds", icon: "Sun", name_fr: "Nuages", name_en: "Clouds" },
  SectionSeed { id: "water-cycle", domain_id: "earth", article_id: "water-cycle", icon: "Waves", name_fr: "Cycle de l'eau", name_en: "Water Cycle" },
  SectionSeed { id: "rivers-and-seas", domain_id: "earth", article_id: "water-cycle", icon: "Waves", name_fr: "Rivières et mers", name_en: "Rivers and Seas" },
  SectionSeed { id: "food", domain_id: "everyday-life", article_id: "bread", icon: "HeartPulse", name_fr: "Alimentation", name_en: "Food" },
  SectionSeed { id: "cooking", domain_id: "everyday-life", article_id: "bread", icon: "HeartPulse", name_fr: "Cuisine", name_en: "Cooking" },
  ...
  SectionSeed { id: "reading", domain_id: "everyday-life", article_id: "library", icon: "BookOpen", name_fr: "Lecture", name_en: "Reading" },
  ...
  SectionSeed { id: "waste", domain_id: "everyday-life", article_id: "recycling", icon: "Trees", name_fr: "Déchets et ressources", name_en: "Waste and Resources" },
];
